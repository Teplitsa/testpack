...
<form class="leyka-pm-form" id="<?php echo leyka_pf_get_form_id();?>" action="<?php echo leyka_pf_get_form_action();?>" method="post">
	...
	<div class="tst-textfield leyka-field name">
		<input type="text" class="required tst-textfield__input" name="name" id="leyka_donor_name" value="" placeholder="Ваше имя" autocomplete="name">				
	...
	<div class="tst-textfield leyka-field email">
		<input type="email" value="" id="leyka_donor_email" name="email" class="required email tst-textfield__input" placeholder="Ваш email" autocomplete="email">
