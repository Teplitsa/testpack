...
add_filter( "manage_edit-marker_cat_columns", 'rdc_common_tax_columns_names', 10);
...
add_filter( "manage_marker_cat_custom_column", 'rdc_common_tax_columns_content', 10, 3);
