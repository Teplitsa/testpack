...
/** Map **/
//add_shortcode('pw_map', 'tst_pw_map_screen');
function tst_pw_map_screen($atts){
	...
	$coord = tst_map_get_coordinates($address);	
...
function tst_map_get_coordinates( $address, $force_refresh = false ) {
...
/** Toggle **/
if(!shortcode_exists( 'tst_spoiler' ))
	add_shortcode('tst_spoiler', 'tst_su_spoiler_screen');
...
function tst_su_spoiler_screen($atts, $content = null){
	...
	ob_start();
?>
<div class="tst-spoiler<?php echo $class;?>">
	<div class="tst-spoiler-title"><span class="tst-spoiler-icon"></span><?php echo $title;?></div>
	<div class="tst-spoiler-content"><?php echo apply_filters('tst_the_content', $content);?></div>
</div>
<?php
	$out = ob_get_contents();
	ob_end_clean();
