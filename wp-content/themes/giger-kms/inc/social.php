...
/** == Call request == */
function tst_get_call_request_form(){
    $code = "[formidable title=false description=true id='call_request_form']";
    return do_shortcode($code);
}

add_shortcode('call_request_form', 'tst_call_request_form_screen');
function tst_call_request_form_screen($atts){

    return "<div class='call-request-form'>".tst_get_call_request_form()."</div>";
}
