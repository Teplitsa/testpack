<?php
/*
Widget Name: [TST] 4 Блока-опции
Description: 4 Стандартизированных блока с заголовком текстом и кнопкой
*/

class TST_Feature4Block_Widget extends SiteOrigin_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			'[TST] 4 Блока',
			array(
				'description' => 'Ряд из 4 блоков с заголовком, текстом, кнопкой, выровненных по высоте'
			),
			array(
	...
	public function get_template_variables( $instance, $args ) {
		...
		$sections = array('col1', 'col2', 'col3', 'col4');
...
//register
siteorigin_widget_register('tst-feature4block', __FILE__, 'TST_Feature4Block_Widget');
