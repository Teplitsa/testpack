...
try {
	...
	$text_widgets = array(
		1 => array(
			'title' => '',
			'text' => 'Автономная некоммерческая организация по профилактике социально значимых заболеваний - поддержка людей, живущих с ВИЧ, в&nbsp;Оренбурге и Оренбургской обл.'.chr(10).chr(10).'г. Оренбург, ул. Кирова, 30, помещение 14 (домофон 60)'.chr(10).'тел.:  <a href="tel:+73532465656" target="_blank">+7 (3532) 46-56-56</a>, <a href="tel:+79510315656" target="_blank">+7 (951) 031-56-56</a>'.chr(10).'<a href="mailto:new.life.aids@mail.ru" target="_blank">new.life.aids@mail.ru</a>',
			'filter' => 1
		),
		2 => array(
		...
		3 => array(
			'title' => 'Копилка',
			'text' => 'Для участников Группы взаимопомощи появилась возможность сделать свой вклад в улучшение работы организации.'.chr(10).chr(10).'<a href="item/support-group/group-finance/" class="button">Внести вклад</a>',
			'filter' => 1
		),
	);
