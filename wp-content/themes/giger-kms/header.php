...
<header id="site_header" class="site-header">
		...
		<div class="site-panel-row">
			<div class="site-branding site-panel-cell">				
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="site-logo">
					...
					<div id="logo-small" ><?php tst_site_logo('small');?></div>
					<div class="logo-name-cell">
						<?php $header_title_1 = get_theme_mod('header_title_one'); ?>
						<h1 class="logo-name"><?php echo apply_filters('tst_the_title', $header_title_1); ?></h1>
						<?php $header_title_2 = get_theme_mod('header_title_two'); ?>
						<h2 class="logo-name"><?php echo apply_filters('tst_the_title', $header_title_2); ?></h2>
					</div>
				</a>					
			</div>
			...
			<div class="site-details site-panel-cell">
				<div class="site-details-cell"><?php echo apply_filters('tst_the_content', $header_text); ?></div>
			</div>									
			
			<div class="trigger-button donate site-panel-cell">
				<a id="trigger_donate"  href="<?php echo home_url('campaign/help-us');?>"><?php tst_svg_icon('icon-logo');?><?php _e( 'Donate', 'tst' ); ?></a>
			</div>
			
			<div class="trigger-button menu site-panel-cell">
				<a id="trigger_menu" href="<?php echo home_url('sitemap');?>">
					<?php tst_svg_icon('icon-menu');?>					
				</a>				
			</div>
	...
	<nav id="site_nav" class="site-nav">
		<div class="site-nav-title">
			...
			<div id="trigger_menu_close" class="trigger-button close"><?php tst_svg_icon('icon-close');?></div>
		</div>
		<?php
