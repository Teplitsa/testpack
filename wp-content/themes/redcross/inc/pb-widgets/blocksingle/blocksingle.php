<?php
/*
Widget Name: [PB] Single Block
Description: Вывод блока-карточки для галереи блоков
*/
...
class TST_SingleBlock_Widget extends SiteOrigin_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			'Блок-карточка',
			array(
				'description' => 'Вывод блока-карточки для галереи блоков (напр., люди или организации)'				
			),
			array(
