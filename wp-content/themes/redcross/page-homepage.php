...
<section class="main-content single-post-section onhome">
	...
	<?php
		...
		if($nquery->have_posts()){
			rdc_more_section($nquery->posts, __('Our news', 'rdc'), 'news');
		}
	?>
	</div></div>
	...
	<div class="newsletter-block"><div class="container">
		<div class="frame">
			<div class="bit md-4">
				...
				<p><?php _e('Stay connected and be informed', 'rdc');?></p>
			</div>
			...
			<div class="programm-gallery cp-block">				
				<?php
					...
					if($pquery->have_posts()){
						rdc_more_section($pquery->posts, __('More about our programms', 'rdc'), 'programms');
					}
				?>
			</div>
			
			<div class="help-block cp-block">
				<h2><?php _e('Would you like to help? Support our work', 'rdc');?></h2>				
				<?php
					...
					<div class="frame eqh-container">
						<div class="bit md-6 eqh-el">
							<div class="hb-item mentor">
								...
								<p class="cta"><a href="<?php echo $menot_url;?>"><?php _e('Become mentor', 'rdc');?></a></p>
							</div>
						</div>
						<div class="bit md-6 eqh-el">
							<div class="hb-item donate">
								<?php echo apply_filters('the_content', $donor_txt); ?>
								<p class="cta"><a href="<?php echo $donor_url;?>"><?php _e('Donate', 'rdc');?></a></p>
							</div>
						</div>
					</div><!-- .frame -->				
			</div>
			
			<div class="entry-content narrow cp-block"><?php echo apply_filters('rdc_the_content', $bottom); ?></div>
		</main>
	</div>
