...
$tst = __("Teplitsa of social technologies", 'krbl');
	...
	<div class="frame frame-wide">
		<div class="bit md-9 lg-8">
			<?php if(!is_page('subscribe'))	{ ?>
				<h5><?php _e('Subscribe to our newsletter', 'krbl');?></h5>
				<div class="newsletter-form in-footer">
					<?php echo krbl_get_newsletter_form('bottom');?>
				</div>
			<?php } else { ?>
				&nbsp;
			<?php  }?>
		...
		<div class="bit md-3 lg-3 lg-offset-1">
			<h5><span class="icons-label"><?php _e('Our social profiles', 'krbl');?></span>&nbsp;</h5>
			<?php echo krbl_get_social_menu(); ?>
		</div>
	</div>
</div></div>
...
<footer class="site-footer"><div class="container-wide">		
	...
	<div class="sf-cols">
		...
		<div class="sf-cols-8">		
			...
			<div class="copy">
				<?php echo apply_filters('krbl_the_content', $footer_text); ?>	
				<p><?php printf(__('All materials of the site are avaliabe under license %s', 'krbl'), $cc_link);?></p>
			</div>
		...
		<div class="sf-cols-4">
			<div class="te-st-bn">
				...
				<a title="<?php echo $tst;?>" href="http://te-st.ru/" class="krbl-banner">					
					<svg class="krbl-icon"><use xlink:href="#icon-te-st" /></svg>
				</a>
			</div>			
		</div>
	</div>
