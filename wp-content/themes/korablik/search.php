...
function krbl_build_results_label($number){
...
<section class="heading">
	<div class="container">
		...
		<div class="sr-num"><?php echo krbl_build_results_label($num);?></div>
	</div>
</section>
...
<section class="main-content search-results"><div class="container">
	<?php
		if(empty($s_query)){
			$l = __('Enter terms for search in the form and hit Enter', 'krbl');
			echo "<article class='tpl-search'><div class='entry-summary'><p>{$l }</p></div></article>";							
		}
		elseif($num == 0){
			$l = __('Nothing found under your request', 'krbl');
			echo "<article class='tpl-search'><div class='entry-summary'><p>{$l}</p></div></article>";				
		}
		else {
