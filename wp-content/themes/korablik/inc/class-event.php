...
class TST_Event {
	...
	public function posted_on_card(){
		...
		return implode(krbl_get_sep('&middot;'), $meta);
	...
	public function posted_on_single(){
		...
		if($this->is_expired()){
			...
			$meta[] = krbl_add_to_calendar_link($this, false, 'date tst-add-calendar', $this->date_mark_for_context('single_top'));
		}
		
		$meta[] = ($this->city) ? krbl_get_sep('&middot;')."<span class='city'>".$this->city."</span>" : '';	
