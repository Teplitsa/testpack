...
<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'kds' ); ?></a>
...
<header id="site_header" class="site-header">
	...
	<div class="container">
		...
		<div class="site-branding">
			<!-- <button id="menu-trigger" class="trigger-button menu"><?php kds_svg_icon('icon-menu');?></button> -->
