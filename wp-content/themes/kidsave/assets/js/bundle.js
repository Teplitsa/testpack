...
jQuery(document).ready(function($){
	...
	$(window).scroll(function () {
		...
		//sticky sharing
		if (winW >= breakPointMedium && $('#kds_sharing').length > 0) {
			stickInParent('#kds_sharing .social-likes-wrapper', '#kds_sharing', position, fixedTopPosition);
		}
		
		//sticky sidebar
		if (winW >= breakPointMedium && $('#kds_sidebar').length > 0) {
			stickInParent('#kds_sidebar .related-widget', '#kds_sidebar', position, fixedTopPosition);
		}
